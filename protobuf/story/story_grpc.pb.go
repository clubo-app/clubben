...
type StoryServiceClient interface {
	...
	GetPastByUser(ctx context.Context, in *GetPastByUserRequest, opts ...grpc.CallOption) (*PagedStories, error)
...
func (c *storyServiceClient) GetPastByUser(ctx context.Context, in *GetPastByUserRequest, opts ...grpc.CallOption) (*PagedStories, error) {
	out := new(PagedStories)
	err := c.cc.Invoke(ctx, "/story.StoryService/GetPastByUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StoryServiceServer interface {
	...
	GetPastByUser(context.Context, *GetPastByUserRequest) (*PagedStories, error)
...
func (UnimplementedStoryServiceServer) GetPastByUser(context.Context, *GetPastByUserRequest) (*PagedStories, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPastByUser not implemented")
}
...
func _StoryService_GetPastByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPastByUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StoryServiceServer).GetPastByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/story.StoryService/GetPastByUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StoryServiceServer).GetPastByUser(ctx, req.(*GetPastByUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPastByUser",
			Handler:    _StoryService_GetPastByUser_Handler,
		},
		{
